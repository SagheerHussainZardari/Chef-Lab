...
import com.sagheerhussainzardari.cheflab.Fragments.SearchDishFragment
...
class SearchDishesAdapter(
    ...
    var searchFragment: SearchDishFragment
) :
    RecyclerView.Adapter<SearchDishesAdapter.MyViewHolder>() {
...
//            searchFragment.onVideoIconClicked(dishesList[position].dishVideo)
//        }

//        holder.view.btn_favDish.setOnClickListener {
////            context.toastshort("fav icon clicked")
//
//            searchFragment.onFavIconClicked(dishesList[position].dishName)
//        }

        holder.view.dish_card.setOnClickListener {
            searchFragment.onCardClicked(dishesList[position])
        }
