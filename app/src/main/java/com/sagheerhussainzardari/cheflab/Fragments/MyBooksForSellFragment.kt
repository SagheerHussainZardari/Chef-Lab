...
import com.sagheerhussainzardari.cheflab.Adapters.BookSellMyBooksForSellAdapter
...
import kotlinx.android.synthetic.main.fragment_mybooksforsell.*
import kotlinx.android.synthetic.main.fragment_sellbook.*
import kotlinx.android.synthetic.main.layout_editbook.*
...
class MyBooksForSellFragment : Fragment() {
    ...
    companion object {
        ...
        var bookToEdit: BookSellModel? = null
    ...
    private fun setUpRecyclerView(booksList: ArrayList<BookSellModel>) {
    ...
    fun onBookDelete(book: BookSellModel) {
    ...
    fun onBookEdit(book: BookSellModel) {
        bookToEdit = book
